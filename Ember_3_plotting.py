...
text_file = 'prt5_params_Ember_3.txt'
csv_file = 'plotdata_Ember_3.csv'
...
plt.subplot(3, 2, 1)
plt.scatter(x_values, y_values, s=5, c='blue', marker='o', cmap=None)
plt.xlabel('X')
plt.ylabel('Y')
# set axes range
plt.xlim(325, 700)
...
plt.subplot(3, 2, 2)
sns.kdeplot(x_values, c='cyan')
plt.xlabel('X')
plt.ylabel('Probability')
plt.xlim(325, 700)

plt.subplot(3, 2, 3)
sns.kdeplot(y_values, c='red')
plt.xlabel('Y')
plt.ylabel('Probability')
plt.xlim(-10, 220)

plt.subplot(3, 2, 4)
sns.kdeplot(data=df, x=x1_values, y=y1_values, cmap="BuPu", fill=True, bw_adjust=.75, cbar=True)
