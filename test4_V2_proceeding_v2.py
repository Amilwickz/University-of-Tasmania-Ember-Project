...
w = open('prt5_output.txt', 'w')
z = open('prt5_params.txt', 'w')
...
for fileCtr in range(13,28):
    ...
    if fileCtrP1 < 10:
        ...
        f = open(os.path.abspath(
            'C:/Users/amilaw/Desktop/Ember project/5. prt files processing/test4_proceeding_V2/Ember_Project_test_4_000' + '%d' % fileCtrP1 + '.prt5'), 'rb')
    else:
        f = open(os.path.abspath(
            'C:/Users/amilaw/Desktop/Ember project/5. prt files processing/test4_proceeding_V2/Ember_Project_test_4_00' + '%d' % fileCtrP1 + '.prt5'), 'rb')
