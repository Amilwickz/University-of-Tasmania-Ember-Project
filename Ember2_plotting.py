...
text_file = 'prt5_params_Ember_2.txt'
csv_file = 'plotdata_Ember_2.csv'
...
plt.subplot(3, 2, 1)
plt.scatter(x_values, y_values, s=5, c='orange', marker='o', cmap=None)
plt.xlabel('X')
plt.ylabel('Y')
# set axes range
plt.xlim(325, 700)
...
plt.subplot(3, 2, 2)
sns.kdeplot(x_values, c='magenta')
plt.xlabel('X')
plt.ylabel('Probability')
plt.xlim(325, 700)

plt.subplot(3, 2, 3)
sns.kdeplot(y_values, c='brown')
plt.xlabel('Y')
plt.ylabel('Probability')
plt.xlim(-10, 220)

plt.subplot(3, 2, 4)
sns.kdeplot(data=df, x=x1_values, y=y1_values, cmap="Oranges", fill=True, bw_adjust=.75, cbar=True)
