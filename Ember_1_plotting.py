...
text_file = 'prt5_params_Ember_1.txt'
csv_file = 'plotdata_Ember_1.csv'
...
plt.subplot(3, 2, 1)
plt.scatter(x_values, y_values, s=5, c='purple', marker='o', cmap=None)
plt.xlabel('X')
plt.ylabel('Y')
# set axes range
plt.xlim(325, 700)
...
plt.subplot(3, 2, 2)
sns.kdeplot(x_values, c='green')
plt.xlabel('X')
plt.ylabel('Probability')
plt.xlim(325, 700)

plt.subplot(3, 2, 3)
sns.kdeplot(y_values, c='blue')
plt.xlabel('Y')
plt.ylabel('Probability')
plt.xlim(-10, 220)
